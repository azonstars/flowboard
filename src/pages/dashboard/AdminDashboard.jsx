...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-5">
      ...
      {loading && <div className="bg-white rounded-xl p-10 text-center text-gray-400 shadow-sm"><p className="text-3xl mb-2">⏳</p><p className="text-sm">Loading analytics...</p></div>}
